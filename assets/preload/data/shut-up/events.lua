...
function onStepEvent(curStep)
    ...
    if curStep == 256 or curStep == 1152 then
        ...
        cameraFlash("hud", flashingLights and "FF0000" or "0x90FF0000", EasyMode and 0.75 or 1.5, true)
        zoomMultiply = 1.5
        intense = true
    end
    ...
    if curStep == 384 or curStep == 1280 then
        ...
        cameraFlash("other", flashingLights and "FFFFFF" or "0x90FFFFFF", EasyMode and 0.5 or 1, true)
    end
    ...
    if curStep == 512 or curStep == 1536 then
        ...
        if curStep == 1536 then
            ...
            cameraFlash("hud", flashingLights and "FFFFFF" or "0x90FFFFFF", 0.75, true)
        end
