...
function onCreatePost()
    ...
    makeLuaText('instruction', 'You will gain less HP when your scores is below opponent\'s scores' .. (HardMode and '\nHARD MODE: GHOST TAPPING DISABLED' or ''), 700, 0, 740)
...
function opponentNoteHit(membersIndex, noteData, noteType, isSustainNote)
    ...
    if not isSustainNote then
        opScores = opScores + (EasyMode and 250 or 300)
        if HardMode then
